...
def load_prediction_model():
    model = tf.keras.models.load_model(r'/sebsmedina/CustomPokedex/blob/main/pokedex_model.h5')
    return model

# Cargar los nombres de las clases (los Pokémon)
@st.cache_data
def load_class_names():
    class_names = np.load(r'/sebsmedina/CustomPokedex/blob/main/pokemon_class_names.npy', allow_pickle=True)
    return class_names
